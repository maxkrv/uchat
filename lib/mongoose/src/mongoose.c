...
/*
 *  The following assets local tables must be filled-in before the first use of
 ...
 *
 *  Fills the AES key expansion tables allocated above with their assets
 *  data. This is not "per key" data, but assets system-wide read-only
